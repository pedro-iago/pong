...
return cljs.core.reset_BANG_.call(null,st,cljs.core.reduce.call(null,(function (p1__33692_SHARP_,p2__33693_SHARP_){
return cljs.core.assoc_in.call(null,p1__33692_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("count","by-id","count/by-id",-2098627242),p2__33693_SHARP_,new cljs.core.Keyword(null,"mult","mult",1466794774)], null),mult);
...
new cljs.core.Keyword(null,"on-click","on-click",1632826543).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"triangle","triangle",-1828376667).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"entities","entities",1940967403).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,pong.core.app_state))));
...
pong.aframe_react.serialize.call(null,new cljs.core.Keyword("fear","a","fear/a",-2111880594).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"entities","entities",1940967403).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,pong.core.app_state))));
cljs.core.reset_BANG_.call(null,pong.core.app_state,cljs.core.reduce_kv.call(null,(function (p1__33694_SHARP_,p2__33695_SHARP_,p3__33696_SHARP_){
return cljs.core.assoc.call(null,p1__33694_SHARP_,p2__33695_SHARP_,p3__33696_SHARP_);
...
var el_33699 = om.dom.node.call(null,om.next.class__GT_any.call(null,pong.core.reconciler,pong.aframe_react.Entity));
console.log(el_33699);

el_33699.addEventListener("click",((function (el_33699){
return (function (){
return console.log("Click!");
});})(el_33699))
);

(el_33699["onclick"] = ((function (el_33699){
return (function (){
