...
pong.system.ALL2 = com.rpl.specter.impl.no_params_compiled_path.call(null,com.rpl.specter.impl.__GT_TransformFunctions.call(null,com.rpl.specter.impl.StructurePathExecutor,(function (structure,next_fn){
return cljs.core.doall.call(null,cljs.core.mapcat.call(null,next_fn,structure));
}),(function (structure,next_fn){
var coerce_fn = ((cljs.core.map_QMARK_.call(null,structure))?(function (p1__36803_SHARP_){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,p1__36803_SHARP_);
}):cljs.core.identity);
...
pong.system.KEY_VAL = com.rpl.specter.comp_paths.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [pong.system.ALL2,com.rpl.specter.collect_one.call(null,com.rpl.specter.FIRST),com.rpl.specter.LAST], null));
pong.system.sys_vel = (function pong$system$sys_vel(st,dt){
return cljs.core.update.call(null,st,new cljs.core.Keyword(null,"position","position",-2011731912),cljs.core.merge,com.rpl.specter.transform.call(null,pong.system.KEY_VAL,(function (p1__36809_SHARP_,p2__36810_SHARP_){
return clojure.core.matrix.operators._PLUS_.call(null,p1__36809_SHARP_.call(null,new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(st)),clojure.core.matrix.operators._STAR_.call(null,p2__36810_SHARP_,dt));
}),new cljs.core.Keyword(null,"velocity","velocity",-581524355).cljs$core$IFn$_invoke$arity$1(st)));
});
pong.system.NAME_VAL = com.rpl.specter.comp_paths.call(null,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [pong.system.ALL2,com.rpl.specter.transformed.call(null,com.rpl.specter.FIRST,(function (p1__36811_SHARP_){
return cljs.core.keyword.call(null,cljs.core.name.call(null,p1__36811_SHARP_));
})),com.rpl.specter.collect_one.call(null,com.rpl.specter.FIRST),com.rpl.specter.LAST,pong.system.ALL2,com.rpl.specter.LAST], null));
pong.system.sys_ctrl = (function pong$system$sys_ctrl(st,dt){
return cljs.core.merge_with.call(null,cljs.core.merge,st,com.rpl.specter.transform.call(null,pong.system.NAME_VAL,(function (p1__36813_SHARP_,p2__36812_SHARP_){
return cljs.core.apply.call(null,new cljs.core.Keyword(null,"transform","transform",1381301764).cljs$core$IFn$_invoke$arity$1(p2__36812_SHARP_),com.rpl.specter.select.call(null,cljs.core.apply.call(null,com.rpl.specter.multi_path,new cljs.core.Keyword(null,"params-path","params-path",-1084788678).cljs$core$IFn$_invoke$arity$1(p2__36812_SHARP_)),st));
