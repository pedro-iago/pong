...
goog.addDependency("../pong/aframe_react.js", ['pong.aframe_react'], ['cljs.core', 'cljsjs.react', 'clojure.string', 'om.util']);
...
goog.addDependency("../pong/paths.js", ['pong.paths'], ['com.rpl.specter', 'cljs.core', 'com.rpl.specter.impl', 'clojure.data.avl']);
goog.addDependency("../pong/utils.js", ['pong.utils'], ['com.rpl.specter', 'pong.paths', 'cljs.core', 'clojure.data.avl', 'clojure.string']);
...
goog.addDependency("../pong/systems.js", ['pong.systems'], ['com.rpl.specter', 'pong.utils', 'pong.paths', 'cljs.core', 'clojure.core.matrix.operators', 'clojure.core.matrix', 'clojure.data.avl']);
...
goog.addDependency("../pong/parser.js", ['pong.parser'], ['com.rpl.specter', 'pong.utils', 'cljs.core', 'om.next', 'clojure.data.avl']);
...
goog.addDependency("../pong/fsm.js", ['pong.fsm'], ['com.rpl.specter', 'pong.paths', 'cljs.core', 'clojure.core.matrix.operators', 'clojure.core.matrix', 'clojure.data.avl']);
goog.addDependency("../pong/scripts.js", ['pong.scripts'], ['pong.fsm', 'cljs.core', 'clojure.core.matrix.operators', 'clojure.core.matrix', 'clojure.data.avl']);
goog.addDependency("../pong/ui/spheres.js", ['pong.ui.spheres'], ['pong.aframe_react', 'cljs.core', 'om.dom', 'om.next']);
goog.addDependency("../pong/core.js", ['pong.core'], ['goog.dom', 'pong.aframe_react', 'pong.systems', 'pong.utils', 'pong.parser', 'cljs.core', 'om.dom', 'pong.ui.scenes', 'pong.ui.counters', 'pong.scripts', 'om.next', 'clojure.data.avl', 'pong.ui.spheres']);
...
goog.addDependency("../pong/fiddle.js", ['pong.fiddle'], ['com.rpl.specter', 'pong.aframe_react', 'pong.systems', 'pong.parser', 'cljs.core', 'om.dom', 'cljs.core.async', 'clojure.core.matrix.operators', 'clojure.core.matrix', 'pong.ui.counters', 'om.next', 'pong.core', 'clojure.data.avl', 'pong.ui.spheres']);
