...
}catch (e24998){if((e24998 instanceof Error)){
var e = e24998;
return null;
} else {
throw e24998;
...
if(cljs.core.deref.call(null,figwheel.client.socket.socket_atom)){
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__25008){
...
var retry_count = cljs.core.get.call(null,map__25015__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__25015__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__25015__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
...
var url = [cljs.core.str(websocket_url),cljs.core.str(((build_id)?[cljs.core.str("/"),cljs.core.str(build_id)].join(''):""))].join('');
var socket = (new WebSocket(url));
socket.onmessage = ((function (url,socket,WebSocket,temp__4655__auto__,map__25015,map__25015__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
var and__17776__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__17776__auto__){
var and__17776__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__17776__auto____$1)){
var and__17776__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
});})(url,socket,WebSocket,temp__4655__auto__,map__25015,map__25015__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4655__auto__,map__25015,map__25015__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4655__auto__,map__25015,map__25015__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__17788__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__25015,map__25015__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__25015,map__25015__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__18126__auto__ = (10000);
var y__18127__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__4655__auto__,map__25015,map__25015__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
