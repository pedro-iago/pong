...
var m__17427__auto__ = (sablono.util.to_str[goog.typeOf(x__17426__auto__)]);
if(!((m__17427__auto__ == null))){
return m__17427__auto__.call(null,x);
} else {
var m__17427__auto____$1 = (sablono.util.to_str["_"]);
...
var x__17426__auto__ = (((x == null))?null:x);
var m__17427__auto__ = (sablono.util.to_uri[goog.typeOf(x__17426__auto__)]);
if(!((m__17427__auto__ == null))){
return m__17427__auto__.call(null,x);
} else {
var m__17427__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__17427__auto____$1 == null))){
return m__17427__auto____$1.call(null,x);
} else {
...
var len__17829__auto___18288 = arguments.length;
var i__17830__auto___18289 = (0);
while(true){
if((i__17830__auto___18289 < len__17829__auto___18288)){
args__17836__auto__.push((arguments[i__17830__auto___18289]));

var G__18290 = (i__17830__auto___18289 + (1));
i__17830__auto___18289 = G__18290;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__17837__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq18287){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq18287));
});
/**
...
var vec__18292 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__18292,(0),null);
var words = cljs.core.nthnext.call(null,vec__18292,(1));
...
var G__18294 = clojure.set.rename_keys.call(null,m,kmap);
var G__18294__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__18294,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__18294);
return G__18294__$1;
} else {
return m;
}
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__18295_SHARP_){
if(typeof p1__18295_SHARP_ === 'string'){
return p1__18295_SHARP_;
} else {
return cljs.core.seq.call(null,p1__18295_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__16771__auto__ = x__$1.hasDomain();
