...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__23595_SHARP_){
return ((p1__23595_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__23595_SHARP_ === 'string');
}),class$__$1))){
...
var G__23597 = attrs;
var G__23597__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(attrs))?cljs.core.update_in.call(null,G__23597,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$):G__23597);
return G__23597__$1;
});
/**
...
var len__17829__auto___23600 = arguments.length;
var i__17830__auto___23601 = (0);
while(true){
if((i__17830__auto___23601 < len__17829__auto___23600)){
args__17836__auto__.push((arguments[i__17830__auto___23601]));

var G__23602 = (i__17830__auto___23601 + (1));
i__17830__auto___23601 = G__23602;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__17837__auto__);
});
...
var G__23599 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
var G__23599__$1 = ((!(cljs.core.empty_QMARK_.call(null,classes__$1)))?cljs.core.assoc.call(null,G__23599,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1):G__23599);
return G__23599__$1;
});

sablono.normalize.merge_with_class.cljs$lang$maxFixedArity = (0);

sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq23598){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23598));
});
/**
...
var vec__23606 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__23606,(0),null);
var names = cljs.core.nth.call(null,vec__23606,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__23606,tag_name,names){
return (function (p1__23603_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__23603_SHARP_));
});})(matches,vec__23606,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__23606,tag_name,names){
return (function (p1__23604_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__23604_SHARP_));
});})(matches,vec__23606,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__23607){
var vec__23610 = p__23607;
var tag = cljs.core.nth.call(null,vec__23610,(0),null);
var content = cljs.core.nthnext.call(null,vec__23610,(1));
...
var vec__23611 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__23611,(0),null);
var id = cljs.core.nth.call(null,vec__23611,(1),null);
var class$ = cljs.core.nth.call(null,vec__23611,(2),null);
